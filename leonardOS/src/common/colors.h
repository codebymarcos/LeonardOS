...
// Informação / destaque
#define THEME_INFO          VGA_COLOR(COLOR_LIGHT_CYAN, COLOR_BLACK)
...
#define THEME_BORDER        VGA_COLOR(COLOR_CYAN, COLOR_BLACK)

// Labels (sysinfo, etc.)
#define THEME_LABEL         VGA_COLOR(COLOR_LIGHT_MAGENTA, COLOR_BLACK)
...
#define THEME_BOOT          VGA_COLOR(COLOR_LIGHT_GRAY, COLOR_BLACK)
